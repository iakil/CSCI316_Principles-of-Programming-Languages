...
_lr_productions = [
  ...
  ('statement -> expression','statement',1,'p_statement_expr','main.py',71),
  ...
  ('expression -> - expression','expression',2,'p_expression_uminus','main.py',91),
  ('expression -> ( expression )','expression',3,'p_expression_group','main.py',96),
  ('expression -> NUMBER','expression',1,'p_expression_number','main.py',101),
  ('expression -> NAME','expression',1,'p_expression_name','main.py',106),
]
