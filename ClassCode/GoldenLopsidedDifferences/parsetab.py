...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','main.py',65),
  ('statement -> expression','statement',1,'p_statement_expr','main.py',70),
  ('expression -> expression + expression','expression',3,'p_expression_binop','main.py',75),
  ('expression -> expression - expression','expression',3,'p_expression_binop','main.py',76),
  ('expression -> expression * expression','expression',3,'p_expression_binop','main.py',77),
  ('expression -> expression / expression','expression',3,'p_expression_binop','main.py',78),
  ('expression -> - expression','expression',2,'p_expression_uminus','main.py',90),
  ('expression -> ( expression )','expression',3,'p_expression_group','main.py',95),
  ('expression -> NUMBER','expression',1,'p_expression_number','main.py',100),
  ('expression -> NAME','expression',1,'p_expression_name','main.py',105),
]